...
{% endhighlight %}
 ...
 Также существует обобщенная поддержка пагинации и сортировки, путем предоставления специальных параметров к поисковым методам хранилищ.
...
Возвращаясь к вопросу который был задан в заголовке(One api to rule them all?): нет, в Spring Data нет единого интерфейса ко всем хранилищам. Разница между ними слишком фундаментальна. Но проект Spring Data действительно предоставляет общую модель программирования для доступа к данным. 
